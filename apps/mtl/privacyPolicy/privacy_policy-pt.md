...
* [English version](../privacyPolicy/tth/privacy_policy-en.md)  

A TC Solution leva muito a sério as suas informações privadas.

Esta política mostra nossas práticas de privacidade descrevendo como tratamos às informações que são inseridas por você ou coletadas quando você utiliza o TTH (Contados de 10k horas).
